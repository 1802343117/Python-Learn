"""
爬取知乎一个专栏的所有粉丝数据并存入数据库t_follower
"""
import requests
import json
import pymysql
...
def crawl():
    ...
    for offset in range(0, 100, 20):
        time.sleep(1)
        url = "https://www.zhihu.com/api/v4/columns/xudewen/followers?include=data%5B*%5D.follower_count%2Cgender" \
              "%2Cis_followed%2Cis_following&offset=" + \
              str(offset) + "&limit=20"
        print(url)
        headers = {
